...
Width of checkerboard: If there are 10 boxes in the row, Width of checkerboard = 9
Height of checkerboard: If there are 7 boxes in the column, Height of checkerboard = 6
square_size: measurement of on edge of one box in meters
'''
...
if __name__ == '__main__':
    ...
    ap.add_argument("-s", "--square_size", type=float, default=1, help="Length of one edge (in metres)") #0.03
    ...
    matrix_path = "calibration_matrices"
    print("Calibration Matrix: \n", mtx)
    print("Distortion Coefficients: \n", dist)

    np.save(matrix_path + "/calibration_matrix", mtx)
    np.save(matrix_path + "/distortion_coefficients", dist)
    print("Saved in", matrix_path, "folder.")
